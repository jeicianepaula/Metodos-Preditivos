...
#---------------------------------------------------------GARCH----------------------------------------------------------------------------------------------
GARCH = function (x,Data_IN,Data_OUT,Dados_reais_OUT,h){
    ...
    prevgarch= ugarchforecast(GARCH, n.ahead = h, n.roll = 0 )
...
GARCH(serie,Data[1:156],Data[157:180],Dados[157:180,1],24)
